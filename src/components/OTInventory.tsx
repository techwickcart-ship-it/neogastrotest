...
const INITIAL_OT_INVENTORY: OTInventoryItem[] = [
  ...
  { id: 'oti-2', code: 'OTI002', name: 'Laparoscopic Procedure Kit', category: 'Surgical Kit', stock: 5, unit: 'Kit', minStockLevel: 3, mrp: 8500, purchasePrice: 6000, batchNumber: 'LPK-8812', expiryDate: '2027-06-30' },
  { id: 'oti-3', code: 'OTI003', name: 'Orthopedic Fracture & Trauma Kit', category: 'Surgical Kit', stock: 4, unit: 'Kit', minStockLevel: 2, mrp: 12000, purchasePrice: 9500, batchNumber: 'OFK-4402', expiryDate: '2029-01-15' },
  { id: 'oti-13', code: 'OTI013', name: 'Endoscopy & Biopsy Accessory Kit', category: 'Surgical Kit', stock: 6, unit: 'Kit', minStockLevel: 2, mrp: 6200, purchasePrice: 4800, batchNumber: 'EBK-2026', expiryDate: '2028-08-20' },
  { id: 'oti-14', code: 'OTI014', name: 'ENT Microsurgery Set', category: 'Surgical Kit', stock: 3, unit: 'Kit', minStockLevel: 2, mrp: 9800, purchasePrice: 7500, batchNumber: 'ENT-901', expiryDate: '2029-03-10' },
  ...
  { id: 'oti-5', code: 'OTI005', name: 'Sevoflurane Inhalant Liquid (250ml)', category: 'Anesthesia Drug', stock: 8, unit: 'Bottle', minStockLevel: 5, mrp: 4800, purchasePrice: 3800, batchNumber: 'SVF-001X', expiryDate: '2028-03-10' },
  ...
  { id: 'oti-15', code: 'OTI015', name: 'Bupivacaine Heavy 0.5% (4ml)', category: 'Anesthesia Drug', stock: 50, unit: 'Ampoule', minStockLevel: 20, mrp: 120, purchasePrice: 75, batchNumber: 'BPV-881', expiryDate: '2027-09-15' },
  { id: 'oti-16', code: 'OTI016', name: 'Atracurium Besylate 25mg/2.5ml', category: 'Anesthesia Drug', stock: 40, unit: 'Ampoule', minStockLevel: 15, mrp: 195, purchasePrice: 130, batchNumber: 'ATC-332', expiryDate: '2027-12-01' },
  { id: 'oti-17', code: 'OTI017', name: 'Glycopyrrolate Injection 0.2mg/ml', category: 'Anesthesia Drug', stock: 60, unit: 'Ampoule', minStockLevel: 20, mrp: 65, purchasePrice: 40, batchNumber: 'GCP-102', expiryDate: '2028-05-20' },
  { id: 'oti-18', code: 'OTI018', name: 'Neostigmine Methylsulfate 0.5mg/ml', category: 'Anesthesia Drug', stock: 40, unit: 'Ampoule', minStockLevel: 15, mrp: 85, purchasePrice: 55, batchNumber: 'NST-404', expiryDate: '2028-02-18' },

  // Sutures
  { id: 'oti-7', code: 'OTI007', name: 'Vicryl 2-0 Absorbable Suture', category: 'Suture', stock: 18, unit: 'Box(12pcs)', minStockLevel: 10, mrp: 1800, purchasePrice: 1350, batchNumber: 'VCR-2219', expiryDate: '2029-05-01' },
  ...
  { id: 'oti-19', code: 'OTI019', name: 'Silk 2-0 Braided Non-Absorbable Suture', category: 'Suture', stock: 30, unit: 'Box(12pcs)', minStockLevel: 10, mrp: 1200, purchasePrice: 850, batchNumber: 'SLK-201', expiryDate: '2029-10-30' },
  { id: 'oti-20', code: 'OTI020', name: 'Monocryl 4-0 Monofilament Synthetic Suture', category: 'Suture', stock: 15, unit: 'Box(12pcs)', minStockLevel: 8, mrp: 2400, purchasePrice: 1800, batchNumber: 'MNC-402', expiryDate: '2029-08-14' },
  ...
  { id: 'oti-21', code: 'OTI021', name: 'Suction Tubing with Yankauer Handle', category: 'Disposable', stock: 45, unit: 'Piece', minStockLevel: 15, mrp: 180, purchasePrice: 110, batchNumber: 'SCT-901', expiryDate: '2029-11-20' },
  { id: 'oti-22', code: 'OTI022', name: 'Electrocautery Pencil with Grounding Pad', category: 'Disposable', stock: 35, unit: 'Set', minStockLevel: 10, mrp: 350, purchasePrice: 220, batchNumber: 'ECT-404', expiryDate: '2028-10-15' },
  { id: 'oti-23', code: 'OTI023', name: 'Spinal Needle 25G (Quincke tip)', category: 'Disposable', stock: 80, unit: 'Piece', minStockLevel: 25, mrp: 95, purchasePrice: 55, batchNumber: 'SPN-25G', expiryDate: '2030-03-31' },
  { id: 'oti-24', code: 'OTI024', name: 'Foley Catheter 16 Fr & Latex Free Urobag', category: 'Disposable', stock: 50, unit: 'Set', minStockLevel: 15, mrp: 160, purchasePrice: 95, batchNumber: 'FLY-16F', expiryDate: '2029-06-30' },
  ...
  { id: 'oti-12', code: 'OTI012', name: 'Cortical Screw 3.5mm x 14mm', category: 'Implant', stock: 18, unit: 'Piece', minStockLevel: 10, mrp: 380, purchasePrice: 240, batchNumber: 'IMP-CS35', expiryDate: '2032-04-18' },
  { id: 'oti-25', code: 'OTI025', name: 'Polypropylene Mesh Prosthesis 15cm x 15cm', category: 'Implant', stock: 12, unit: 'Piece', minStockLevel: 4, mrp: 3200, purchasePrice: 2100, batchNumber: 'PPM-1515', expiryDate: '2031-05-20' },
  { id: 'oti-26', code: 'OTI026', name: 'Titanium Hemoclip Medium-Large (Rack of 6)', category: 'Implant', stock: 20, unit: 'Rack', minStockLevel: 5, mrp: 1500, purchasePrice: 980, batchNumber: 'THC-ML6', expiryDate: '2032-01-10' }
];
...
export default function OTInventory() {
  ...
  // Sync and fetch from database & local storage
  useEffect(() => {
    const fetchOTInventory = async () => {
      try {
        ...
        if (stored && Array.isArray(stored) && stored.length > 0) {
          setInventory(stored);
          storage.set('hms_ot_inventory', stored);
          syncWithMasterInventory(stored);
        } else {
          const local = storage.get('hms_ot_inventory', []);
          if (local && Array.isArray(local) && local.length > 0) {
            setInventory(local);
            syncWithMasterInventory(local);
          } else {
            storage.set('hms_ot_inventory', INITIAL_OT_INVENTORY);
            setInventory(INITIAL_OT_INVENTORY);
            syncWithMasterInventory(INITIAL_OT_INVENTORY);
            try {
              const seedPromises = INITIAL_OT_INVENTORY.map(item => supabaseService.createOTInventoryItem(item));
              await Promise.all(seedPromises);
            } catch (e) {
              console.warn('DB seeding skipped, local inventory seeded', e);
            }
          }
        }
      } catch (err) {
        console.warn('Error fetching OT inventory, falling back to initial', err);
        const local = storage.get('hms_ot_inventory', INITIAL_OT_INVENTORY);
        setInventory(local);
      }
    };
    fetchOTInventory();
  ...
  const handleDelete = async (id: string) => {
    if (confirm('Are you sure you want to delete this inventory item?')) {
      ...
      await supabaseService.deleteOTInventoryItem(id);
      
      const updatedList = inventory.filter(i => i.id !== id);
      setInventory(updatedList);
      storage.set('hms_ot_inventory', updatedList);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (editingItem) {
      ...
      const updatedItem = res || { ...editingItem, ...updatedData };
      
      const newList = inventory.map(item => item.id === editingItem.id ? updatedItem : item);
      setInventory(newList);
      storage.set('hms_ot_inventory', newList);
      syncWithMasterInventory(newList);
      ...
      const createdItem = res || newItem;
      
      const newList = [...inventory, createdItem];
      setInventory(newList);
      storage.set('hms_ot_inventory', newList);
      syncWithMasterInventory(newList);
