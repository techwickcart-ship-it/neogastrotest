...
export default function Login({ onLogin }: LoginProps) {
  ...
  const fallbackUserProfiles: Record<string, any> = {
    ...
    'admin': { id: 'u-admin-quick', name: 'Hospital Admin', email: 'admin', role: 'SUPER_ADMIN', department: 'Administration', specialization: 'Hospital Administration', degree: 'MD, MBA', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=AdminQuick' },
